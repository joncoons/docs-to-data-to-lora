...
os.environ.setdefault("JUDGE_API_URL", "http://localhost:8001/v1")
...
os.environ.setdefault("SINGLEAXIS_OUTPUT_ROOT", "<EVAL_ROOT>/singleaxis-llm")

from scripts.eval.direct_llm_singleaxis_impl import main  # noqa: E402
