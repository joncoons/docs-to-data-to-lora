...
The Customizer dry-run emits SDK create-job arguments with `name`, `workspace`,
and `spec`. The `spec.dataset` field points at the FileSet URI generated by the
FileSet handoff step, for example `fileset://default/stage3-nim-curated`.
